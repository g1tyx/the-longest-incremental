...
var cnItems = {
    ...
    "Dark Toning 4 is free, and always at maximum.": "黑暗色调 4 是免费的，并且始终是最大的。",
    "Dark Tonings.": "黑暗色调。",
    "Dark World": "黑暗的世界",
    ...
    "Nerd Boosters": "书呆子助推器",
    "Scientific": "科学计数法",
    "Get 1.00e30 while consuming 6 times.": "消费 6 次时获得 1.00e30。",
    "Reach 1.00e25 points with only 1 maker. Reward: Gain +10% more Points. (additive)": "仅使用 1 个制造商 达到 1.00e25 点数。 奖励：获得 +10% 更多积分。 （附加）",
    "Buildings produce more points. (variable)": "建筑物产生更多点数。 （变量）",
    "Play": "播放",
    "Stop": "停止",
    "Cheapen Enhancements based on Dark Tonings.": "基于深色色调增强功能更便宜了。",
    "[1] Anti-Buildings": "[1] 反建筑",
    "[2] Light Energy": "[2] 光能",
    "[3] Deboosted": "[3] 降压",
    "[4] Hyperscaling": "[4] 超缩放",
    "[5] Insufficient Power": "[5] 电力不足",
    "[6] Zenith": "[6] 天顶",
    "4: Hyperscaling!": "4：超大规模！",
    "Always have Creator unlocked.": "始终解锁 Creator。",
    "At 5 Recall Factor, all Dark Resources are gettable up to [1,1,1].": "在 5 Recall Factor 时，所有暗资源都可以达到 [1,1,1]。",
    "At 5 Recall Factor, all Dark Resources are gettable up to [2,2,2].": "召回因子为 5 时，所有暗资源都可达到 [2,2,2]。",
    "Boosters are weaker. Toning 2 is disabled.": "助推器较弱。色调 2 被禁用。",
    "Buildings and Toning 1 are disabled. You gain +1 base Point/s. Booster cost scaling is reduced.": "建筑物和色调 1 被禁用。你获得+1 基点/秒。助推器成本缩放减少。",
    "Buildings, Boosters, and Enhancements' scalings are greatly increased. Toning 4 is disabled.": "建筑、助推器和增强的缩放比例大大增加。色调 4 被禁用。",
    "By: DeLorean": "作者：DeLorean",
    "By: downvoid": "作者：downvoid",
    "By: Everyone!": "作者：所有人！",
    "By: jwklong, TehAarex": "作者：jwklong, TehAarex",
    "By: meta": "作者：meta",
    "C1 completions boost Dark Resources gain (even from Fusing) by 4.86x.": "C1 完成将黑暗资源增益（甚至来自 融合）提高 4.86 倍。",
    "Challenges 2, 3, and 5 are all applied.": "挑战 2、3 和 5 均已应用。",
    "Dark Condenser 2: Boost Dark Toning 2 but reduce their cap by 1.48x.": "Dark Condenser 2：提升 Dark Toning 2，但将其上限降低 1.48 倍。",
    "Dark Condenser 3: Boost Dark Toning 3 but reduce their cap by 1.70x.": "Dark Condenser 3：提升 Dark Toning 3，但将其上限降低 1.70 倍。",
    "Dark Condenser 5: Boost Dark Toning 5 but reduce their cap by 1.00x.": "Dark Condenser 5：提升 Dark Toning 5，但将其上限降低 1.00 倍。",
    "Dark Toning 4 is always at maximum.": "Dark Toning 4 始终处于最大值。",
    "Dark Tonings scale 50% faster and you cannot gain extra Tonings. Toning 3 is disabled.": "Dark Tonings 的缩放速度提高 50%，并且您无法获得额外的 Tonings。色调 3 被禁用。",
    "Each achievement boosts Dark Energy by +10% (additive). Currently: 3.90x.": "每项成就都会将暗能量提升 +10%（附加）。当前：3.90 倍。",
    "Exit Challenge": "退出挑战",
    "Gain 2x more Dark Resources, even from Fusing.": "获得 2 倍更多黑暗资源，即使来自融合。",
    "Gives 27 free boosters for  enhancing.": "提供 27 个免费助推器用于增强。",
    "Multiply Coolant and Heatant by 1.00x.": "将冷却剂和加热剂乘以 1.00 倍。",
    "Multiply Recall Base by 1.25x.": "将召回基础乘以 1.25 倍。",
    "Outside of Darken Challenges, Boosters reset nothing.": "在变暗挑战之外，助推器不会重置任何内容。",
    "Outside of Darken Challenges, Resizer maximum is always at max points over Darken runs.": "在 Darken Challenges 之外，Resizer 最大值总是在 Darken 运行中达到最大值。",
    "Points are reduced to ^0.75 and Dark Energy is reduced to ^0.55.": "点数减少到 ^0.75，暗能量减少到 ^0.55。",
    "Start Challenge": "开始挑战",
    "Start with first 5 booster milestones.": "从前 5 个助推器里程碑开始。",
    "Unlock Elemental Essences.": "解锁元素精华。",
    "Unlock Elemental. [SOON]": "解锁元素。 [很快]",
    "Unlock new Dark Resources.": "解锁新的黑暗资源。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Cheapen Enhancements by ": "更便宜的增强功能 ",
    "Raise Upgrade 1 by ^": "将升级 1 提高 ^",
    "Factory Enhances raise Buyable base cost by ^": "工厂增强将可购买的基础成本提高 ^",
    "Playing: ": "正在播放：",
    "(D) Darken the sun.": "(D) 使太阳变暗。",  
    "You're currently in Challenge ": "你当前在挑战 ",
    "Ability cooldown is ": "技能冷却时间为 ",
    "Boost Timewarp Power by ": "提升时间扭曲力量 ",
    "Multiply Coolant by ": "将冷却剂乘以 ",
    "Multiply Heatant by ": "将加热剂乘以 ",
    "Each Enhance boosts Dark Energy by ": "每次增强都会将暗能量提升 ",
    "Each Dark Toning boosts Dark Energy by ": "每种暗色调都会将暗能量提升 ",
    "Multiply Recall Resources by ": "将召回资源乘以 ",
    "Resizing efficiency is ": "调整大小的效率是 ",
    "Raise Creator's effect by ": "将造物主的效果提升 ",
    "Speed up pre-Darken by ": "加快预变暗的速度 ",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPostfix = {
    ...
    " Use!": " 使用!",
    ": Light Energy!": ": 光能!",
    "x boost to Dark Energy.": "x 提升到暗能量。",
    "x boost to Creator Power gain.": "x 提升到创造者力量增益。",
    "x. (based on Dark Tonings)": "X。 （基于暗色调）",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Get (.+) points.$/, '获得 $1 点数。'],
    [/^Get (.+) extra Dark Tonings.$/, '获得 $1 额外的暗色调。'],
    [/^Gain (.+)x Points based on remaining Boosters.$/, '根据剩余的助推器获得 $1x 点数。'],
    [/^Add (.+) effective Boosters.$/, '添加 $1 有效助推器。'],
